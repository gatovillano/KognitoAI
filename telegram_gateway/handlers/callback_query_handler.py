# telegram_gateway/handlers/callback_query_handler.py
...
from telegram_gateway.helpers import Paginator

# Definida localmente en lugar de importar de message_handlers para evitar circular imports
