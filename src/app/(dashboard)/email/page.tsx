...
import { Mail, Puzzle, Settings } from 'lucide-react';
...
export default function EmailPage() {
  ...
  const isInstalled = settings?.installed_extensions?.includes('email_management');
    ...
    return (
      <div className="flex h-[70vh] w-full items-center justify-center px-4">
        <Card className="max-w-md w-full border border-primary/20 bg-card/60 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden relative group">
          ...
          <div className="h-2 w-full bg-gradient-to-r from-violet-500 via-purple-500 to-pink-500" />
          ...
          <CardHeader className="text-center pt-8">
            ...
            <CardTitle className="text-2xl font-bold tracking-tight text-foreground">
              KogniMail no está activo
            </CardTitle>
            <CardDescription className="text-sm text-muted-foreground mt-2">
              KogniMail es una extensión avanzada que te permite gestionar tu bandeja de entrada directamente en KognitoAI usando inteligencia artificial.
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6 pb-8 pt-2">
            <div className="rounded-2xl bg-accent/40 p-4 border border-border/50 space-y-2">
              ...
              <ul className="text-xs text-muted-foreground space-y-1.5 list-disc list-inside">
                <li>Bandeja de entrada inteligente con IMAP/SMTP.</li>
                <li>Resúmenes automáticos de hilos y correos largos.</li>
                <li>Asistente de IA para redacción y traducción de correos.</li>
                <li>Indexación de correos en el cerebro de K Kai.</li>
              </ul>
            </div>
