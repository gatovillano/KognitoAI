...
export default function AnalyticsDashboard() {
  ...
  const handleGenerateTestData = async () => {
    ...
    try {
      // Generamos múltiples peticiones simuladas
      const promises = [];
      ...
      for (let i = 0; i < totalEvents; i++) {
        ...
        // Simular diferentes IDs de sesión para simular diferentes visitantes
        ...
        const apiRequest = fetch(`${apiClient.defaults.baseURL}/api/analytics/track`, {
          ...
          body: JSON.stringify({
            ...
            event_metadata: {
              simulated: true,
              timestamp_offset_hours: Math.floor(Math.random() * 72) // simulado
            }
          }),
        });
      ...
      // Esperar 1.5s antes de refrescar para que la DB asiente los commits
      setTimeout(() => {
        fetchAnalytics();
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Métricas integradas de la landing page y el software en tiempo real.
          </p>
        </div>
