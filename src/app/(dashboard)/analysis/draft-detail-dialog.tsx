...
export function DraftDetailDialog({ analysis, isOpen, onOpenChange }: DraftDetailDialogProps) {
  ...
  const handleExportPDF = async () => {
    ...
    try {
      const response = await apiClient.post('/api/deep_research/export_pdf', {
        ...
        final_report: draftResult.final_report || draftResult.summary || "Sin contenido",
  ...
  if (!draftResult || !(draftResult.final_report || draftResult.summary)) {
    return (
        ...
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto rounded-3xl backdrop-blur-2xl bg-card/95 border-border/50 shadow-2xl">
          <DialogHeader className="p-4">
            <DialogTitle className="text-3xl font-black tracking-tight leading-tight">
              Error al cargar la Borrador Desarrollado
            </DialogTitle>
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <ContextualChat
          ...
          title={analysis.title || "Borrador Desarrollado"}
        />
