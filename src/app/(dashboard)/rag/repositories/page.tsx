    ...
    <div className="h-full flex flex-col p-4 sm:p-8 max-w-7xl mx-auto overflow-x-hidden">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 flex-wrap gap-2">
        <div>
          ...
          <h1 className="text-2xl sm:text-3xl font-bold break-all">Repositorios de GitHub</h1>
        </div>
        <div className="flex items-center gap-2 w-full sm:w-auto">
            <Button onClick={() => setIsGitHubRepoOpen(true)} className="w-full sm:w-auto">
                ...
                <div className="flex justify-between items-start p-4 pb-0 z-20">
                  <div className="flex items-start gap-3 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <CardTitle className="break-words text-base sm:text-lg">{repo.name}</CardTitle>
                      <CardContent className="p-0 pt-1 sm:pt-2">
                        <p className="text-xs text-muted-foreground/80 italic truncate">{repo.url}</p>
                        <p className="text-sm text-muted-foreground mt-0.5 sm:mt-1">{repo.files.length} documento(s)</p>
                      </CardContent>
                    </div>
                  </div>
                  <Button
