...
import { Plus, MessageSquare, BookMarked, Notebook, Calendar, LogOut, Bot, ChevronDown, ChevronRight, Pin, Users, Sparkles, MoreVertical, FolderKanban, Settings, BarChart3, Smartphone, Brain } from 'lucide-react';
      ...
      <div className={cn("w-full", isCollapsed && "flex flex-col items-center")}>
        ...
        <nav className="space-y-2 w-full">
          ...
          <Link href="/rag" passHref onClick={onLinkClick} title="Gestión de Conocimientos">
            ...
            >
              <Brain className={cn("h-5 w-5 transition-transform group-hover:scale-110", !isCollapsed && "mr-3")}/>
