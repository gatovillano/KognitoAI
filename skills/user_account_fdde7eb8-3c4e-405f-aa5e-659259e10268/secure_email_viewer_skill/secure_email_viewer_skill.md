...
- **Error Handling**: Errors are generic to avoid leaking sensitive information

## Usage Examples

### Check Recent Gmail Inbox
```
LLAMADA_A_HERRAMIENTA: secure_email_viewer
...
- `include_body` (optional): Whether to include email body in results (default: false)
...
- Credentials are read from environment variables at runtime and not stored in memory longer than necessary