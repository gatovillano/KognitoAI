...
echo -e "  📱 ${GREEN}Panel Telegram:${NC}   http://localhost:8880/telegram-panel"
echo -e "  🗄️  ${GREEN}PGAdmin:${NC}          http://localhost:5056"
echo ""

echo -e "${YELLOW}🌍 URLs Públicas:${NC}"
echo -e "  🌐 ${GREEN}Frontend:${NC}         https://kognitoai.cloud"
echo -e "  🔧 ${GREEN}API:${NC}              https://apibase.cuerpolibre.cl"
echo -e "  📱 ${GREEN}Telegram Panel:${NC}   https://kognitoai.cloud/telegram-panel"
echo ""
